...
pub(crate) mod tests {
    ...
    /// Re-captured 2026-08-08 for Q2b's wire-hold: `bpm` now reads 0 until the first
    /// tempo lock, and this 4 s clip never locks — the sole intentional diff.
    ...
    pub(crate) const GOLDEN_HOPS: &[(usize, [f32; features::NUM_FEATURES])] = &[
        (
            40,
            [
                0.1402550, 0.1409504, 0.6152689, 0.0273869, 0.0032776, 0.9150828, 0.6669801,
                0.0565822, 0.0162813, 0.3557950, 0.0031548, 0.0127018, 0.0253166, 0.4415764,
                0.0316777, 0.1347190, 0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.2710480,
                0.6099699, 0.7785417, 0.7338346, 0.6270779, 0.5728502, 0.4557935, 0.3411926,
                0.2735227, 0.2778622, 0.3016837, 0.3824752, 0.5378194, 0.6498346, 0.5876555,
                0.3666992, 0.2351193, 0.0749365, 0.1863821, 0.1481298, 0.0841269, 0.3016749,
                0.9999737, 0.2572653, 0.0411858, 0.8181818, 0.7539284, 0.7610300, 0.0000000,
                0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.3725280,
                0.0194502, 0.9947178, 0.0000000, 0.2187360, 0.0000000, 0.1764497, 0.0577751,
                0.9938284, 0.6009454, 0.9458100, 0.4127845, 0.9999694, 0.4485440, 0.4881192,
                0.4763137, 0.4603751, 0.5333866, 0.1859570, 0.4986976, 0.4986969, 0.3528318,
        ...
        (
            172,
            [
                0.1102305, 0.1080646, 0.7951334, 0.6900175, 0.7611723, 0.9349542, 0.8690848,
                0.2405550, 0.0345201, 0.3562543, 0.0132943, 0.0128849, 0.0226155, 0.4402158,
                0.0327185, 0.1916304, 0.0000000, 0.0000000, 0.0000000, 0.0000000, 0.4169460,
                0.4931195, 0.5987754, 0.5700685, 0.4939806, 0.4751822, 0.5056775, 0.4571940,
                0.4102419, 0.4235835, 0.4410326, 0.4640033, 0.5007323, 0.6384188, 0.5775567,
                0.3584088, 0.2244768, 0.0638255, 0.1732863, 0.1376667, 0.0723760, 0.3010190,
                0.9999934, 0.2557099, 0.0375986, 0.8181818, 0.7369188, 0.7459386, 0.0210922,
                0.8181818, 1.0000000, 0.5127004, 0.0000000, 0.0000000, 0.0000000, 0.3879263,
                0.0197077, 0.9949676, 0.0000000, 0.4461714, 0.0000000, 0.3710368, 0.1154715,
                0.9693277, 0.6012465, 0.9458582, 0.3652414, 0.9999987, 0.4890800, 0.5026360,
                0.4690945, 0.4539475, 0.5269697, 0.0719554, 0.4999761, 0.5000186, 0.3531286,
                0.5012279, 0.5197858, 0.5005887, 0.5000213, 0.0000000, 0.0000000,
            ],
        ),
        (
            340,
            [
                0.1529431, 0.1500495, 0.7958502, 0.1752784, 0.0049733, 0.3086761, 0.5809354,
                0.0749775, 0.0220334, 0.3558825, 0.0057794, 0.0126732, 0.0235602, 0.4388202,
                0.0314818, 0.1036804, 0.0000000, 0.6510209, 0.0000000, 0.0013162, 0.4584618,
                0.4586743, 0.5644562, 0.5216897, 0.4544979, 0.4381144, 0.5564202, 0.5299050,
                0.4502555, 0.4357056, 0.4874449, 0.5473770, 0.4820935, 0.6577535, 0.5944609,
                0.3687846, 0.2380634, 0.0745901, 0.1859395, 0.1465119, 0.0799341, 0.3005089,
                0.9999670, 0.2597651, 0.0414844, 0.8181818, 0.7456161, 0.7435966, 0.0413070,
                0.8181818, 1.0000000, 0.5163098, 0.0000000, 0.0000000, 0.7500000, 0.3741339,
                0.0193157, 0.9973286, 0.0000000, 0.4420651, 0.0000000, 0.1658111, 0.1091703,
                0.9934737, 0.6008735, 0.9454567, 0.3603246, 0.9999986, 0.4310345, 0.4896318,
                0.4748431, 0.4592251, 0.5218554, 0.0867592, 0.5000032, 0.4999986, 0.3532109,
    ...
    fn decay_scales_everything_except_holds() {
        ...
        for (i, &v) in f.as_slice().iter().enumerate() {
            match i {
                ...
                // A15 pitch estimate (64), and the v4 overlay-clock counters (81, 82) hold
                // their last value rather than sweeping toward silence.
                18 | 49 | 50 | 64 | 81 | 82 => {
                    assert!(approx_eq(v, 1.0, 1e-6), "index {i} must hold");
                }
