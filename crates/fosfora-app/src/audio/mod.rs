...
pub(crate) mod tests {
    ...
    /// Re-captured 2026-08-09 for Q3 (#2079): the key detector now consumes the pure-fold
    /// unnormalized key chroma (floored at `KEY_FOLD_LO_MIDI`), so `key_*` (49–51) move;
    ...
    pub(crate) const GOLDEN_HOPS: &[(usize, [f32; features::NUM_FEATURES])] = &[
        (
            ...
            [
                ...
                0.6363636, 1.0000000, 0.0159304, 0.0000000, 0.0000000, 0.0000000, 0.3725280,
        ...
        (
            ...
            [
                ...
                0.6363636, 1.0000000, 0.0000963, 0.0000000, 0.0000000, 0.0000000, 0.3879263,
        ...
        (
            ...
            [
                ...
                0.8181818, 1.0000000, 0.5754455, 0.0000000, 0.0000000, 0.7500000, 0.3741339,
