...
Six of the forty-eight, all at default settings:
...
**→ [See all 48 effects in the gallery](docs/GALLERY.md)**
...
**48 built-in**, all audio-reactive out of the box, every parameter a slider you can map to
